...
document.getElementById('chartType').addEventListener('change', (e) => {
    ...
    if (!cachedMainChart || !chartDimensions) {
        drawChart(cachedData, chartType);  // Recalculate everything
    } else {
        drawChartOverlays(chartType);      // Reuse cached chart and limits
    }
});
...
function drawChart(singleMesDs, chartType) {
    ...
    drawChartOverlays(chartType);
}

function drawChartOverlays( chartType) {
